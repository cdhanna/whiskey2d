...
namespace Project
{
	...
	public class Button : GameObject
	{
		...
		protected override void initProperties()
		{
			X = 0f;
			Y = 0f;
			Sprite = new Sprite("__PIXEL__", new Vector(50f, 50f), new Vector(0f, 0f), 0.5f, new Color(255, 255, 255, 255), 0f);
		...
		public Button( ObjectManager objMan ) : base (objMan) { }
		#region INIT_SCRIPTS
		protected override void addInitialScripts()
		{
			base.addScript( new ButtonControl() );
		}
		#endregion
