...
{
	[Serializable] 
	public class LevelChangeButton : GameObject
	{
		...
		protected override void initProperties()
		{
			...
			Layer = null;
			LevelName = "0";
			IdleColor = new Color(255, 255, 255, 255);
			HoverColor = new Color(176, 222, 255, 255);
		}
		#endregion

		public LevelChangeButton( ObjectManager objMan ) : base (objMan) { }
		#region INIT_SCRIPTS
