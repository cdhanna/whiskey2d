...
namespace Project
{
	...
	public class Drone : GameObject
	{
		...
		protected override void initProperties()
		{
			X = 0f;
			Y = 0f;
			Sprite = new Sprite("__PIXEL__", new Vector(60f, 60f), new Vector(0f, 0f), 0.5f, new Color(128, 0, 128, 255), 0f);
		...
		public Drone( ObjectManager objMan ) : base (objMan) { }
		#region INIT_SCRIPTS
		protected override void addInitialScripts()
		{
			base.addScript( new DroneControl() );
		}
		#endregion
