...
{
	[Serializable] 
	public class WaterBlock : GameObject
	{
		...
		protected override void initProperties()
		{
			X = 0f;
			Y = 0f;
			Sprite = new Sprite("__PIXEL__", new Vector(100f, 100f), new Vector(0f, 0f), 0.5f, new Color(128, 128, 255, 255), 0f);
		...
		public WaterBlock( ObjectManager objMan ) : base (objMan) { }
		#region INIT_SCRIPTS
