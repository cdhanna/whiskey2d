...
namespace Whiskey2D.Core
{
    public class BloomComponent //: DrawableGameComponent
    {
        ...
        //}
        public BloomComponent(GraphicsDevice gfx, ContentManager content)
        {
            if (gfx == null)
        ...
        public void loadContent()
        {
            ...
            bloomExtractEffect = Content.Load<Effect>("BloomExtract.mgfx");
            bloomCombineEffect = Content.Load<Effect>("BloomCombine.mgfx");
            gaussianBlurEffect = Content.Load<Effect>("GaussianBlur.mgfx");
