    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        public void AddVertex(Vector2 vertex, Color color)
        {
            ...
            if (primitiveType == PrimitiveType.TriangleStrip)
            {
                ...
                {
                    vertices[positionInBuffer].Position = vertices[0].Position;
                    vertices[positionInBuffer].Color = vertices[0].Color;
                    positionInBuffer++;

                    vertices[positionInBuffer].Position = vertices[positionInBuffer - 2].Position;
                    vertices[positionInBuffer].Color = vertices[positionInBuffer - 2].Color;
                    positionInBuffer++;
        ...
        private void Flush()
        {
            ...
            {
                //loop the object
                AddVertex(new Vector2(vertices[0].Position.X, vertices[0].Position.Y), vertices[0].Color);
