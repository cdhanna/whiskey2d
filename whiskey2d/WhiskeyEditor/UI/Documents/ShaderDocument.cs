...
{
    class ShaderDocument : DocumentTab
    {

        private TextEditorControl editor;
        private ShaderDescriptor desc;
        private FileChangedEventHandler discHandler;
        private string lastText;

        public ShaderDocument(ShaderDescriptor desc, DocumentView parent)
        ...
        public void refreshFromDisc(ShaderDescriptor desc)
        {
